...
OutputDir=installer
OutputBaseFilename=RecipeServerInstaller
SetupLogging=yes
...
Source: "..\InstallDependencies.bat"; DestDir: "{app}";                   Flags: ignoreversion
...
; Uninstall node.js:
Filename: "{sys}\msiexec.exe"; Parameters: "/x {app}\installer\{#NODE}"; RunOnceId: "UninstRecipeServer";

; Remove Firewall Rules:
Filename: "{sys}\netsh.exe"; Parameters: "advfirewall firewall delete rule name=""Node In""  program=""{commonpf64}\nodejs\node.exe"""; Flags: runhidden; RunOnceId: "UninstRecipeServer";
Filename: "{sys}\netsh.exe"; Parameters: "advfirewall firewall delete rule name=""Node Out"" program=""{commonpf64}\nodejs\node.exe"""; Flags: runhidden; RunOnceId: "UninstRecipeServer";

; Remove all leftovers:
Filename: "{sys}\rmdir"; Parameters: "-r ""{app}"""; RunOnceId: "UninstRecipeServer";
